...
control = controls.get(
    "Brightness", None
)  # Note that not all cameras support all controls
...
if control is not None:
    ...
    assert (
        4000 in control.value_range
    )  # set_value only accepts values in this range (again, different cameras have different ranges)
